...
static const  XAie_PlIfMod AieMlPlIfMod =
{
	...
	.ColRst = {0, 0x1},
	.ShimTileSpareRegOff = XAIEMLGBL_PL_MODULE_SPARE_REG,
...
static const  XAie_NocMod AieMlNocMod =
{
	.ShimNocMuxOff = 0x0,
	.ShimNocDeMuxOff = 0x0,
	.ShimNocMux = NULL,
...
/* PL Interface module for SHIMNOC Tiles */
static const  XAie_NocMod AieMlShimTileNocMod =
{
...
{
	{
		.MemZeroisationCtrlRegOff = XAIEMLGBL_MEMORY_MODULE_MEMORY_CONTROL,
	...
	{
		.MemZeroisationCtrlRegOff = XAIEMLGBL_CORE_MODULE_MEMORY_CONTROL,
...
{
	.MemZeroisationCtrlRegOff = XAIEMLGBL_MEM_TILE_MODULE_MEMORY_CONTROL,
	...
	#define AIEMLSHIMTILENOCMOD &AieMlShimTileNocMod
	#define AIEMLNOCMOD &AieMlNocMod
#else
	#define AIEMLSHIMTILEPLIFMOD NULL
	#define AIEMLPLIFMOD NULL
	#define AIEMLSHIMTILENOCMOD NULL
	#define AIEMLNOCMOD NULL
#endif
#ifdef XAIE_FEATURE_INTR_L1_ENABLE
