...
static const XAie_NocMod AieNocMod =
{
	.ShimNocMuxOff = 0x0,
	.ShimNocDeMuxOff = 0x0,
	.ShimNocMux = NULL,
...
static const XAie_NocMod AieShimTileNocMod =
{
...
static const XAie_TileCtrlMod AieShimTileCtrlMod =
{
	...
	#define AIESHIMTILENOCMOD &AieShimTileNocMod
	#define AIENOCMOD &AieNocMod
#else
	#define AIESHIMTILEPLIFMOD NULL
	#define AIEPLIFMOD NULL
	#define AIESHIMTILENOCMOD NULL
	#define AIENOCMOD NULL
#endif
#ifdef XAIE_FEATURE_INTR_L1_ENABLE
