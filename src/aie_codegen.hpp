...
#define _XAIE_EVENT_DMA_MM2DM_LOCAL_MEMORY_STARVATION_UC _XAIE_EVENT_DMA_MM2DM_LOCAL_MEMORY_BACKPRESSURE_UC
#define _XAIE_EVENT_DMA_MM2DM_REMOTE_MEMORY_BACKPRESSURE_UC _XAIE_EVENT_DMA_MM2DM_REMOTE_MEMORY_STARVATION_UC
