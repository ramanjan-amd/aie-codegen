...
static const  XAie_DmaMod Aie4MemTileDmaMod =
{
	...
	.NumMm2sChannels = 6,	/* number of mm2s channels : Actually this should be 5(10) as per AIE4 spec, but to avoid gaps issue kept 6 */
...
{
	.NumBds = 8,	/* Number Bds for each Control MM2S channel */
	.NumChannels = 1,
...
{
	.NumBds = 4,	/* Number Bds for each Trace S2MM channel */
	.NumChannels = 1,
...
static const  XAie_DmaMod Aie4ShimDmaMod =
{
	...
	.NumChannels = 2U,	/* Number of s2mm channels : Actually this should be 1 (2) as per AIE4 spec, but to avoid gaps issue kept 2 */
