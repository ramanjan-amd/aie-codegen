...
#define XAIE_AIE_TILE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_WIDTH		XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_WIDTH
#define XAIE_AIE_TILE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_MASK 		XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_MASK
#define XAIE_AIE_TILE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_DEFVAL		XAIE2PGBL_CORE_MODULE_MODULE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_DEFVAL
...
#define XAIE_MEM_TILE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_WIDTH		XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_WIDTH
#define XAIE_MEM_TILE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_MASK 		XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_MASK
#define XAIE_MEM_TILE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_DEFVAL		XAIE2PGBL_MEM_TILE_MODULE_MODULE_CLOCK_CONTROL_CTRL_PKT_TLAST_ERROR_ENABLE_DEFVAL
...
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0__CTRL_PKT_TLAST_ERROR_ENABLE_WIDTH		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_CTRL_PKT_TLAST_ERROR_ENABLE_WIDTH
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_CTRL_PKT_TLAST_ERROR_ENABLE_MASK 		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_CTRL_PKT_TLAST_ERROR_ENABLE_MASK
#define XAIE_SHIM_TILE_MOD_CLOCK_CONTROL_0_CTRL_PKT_TLAST_ERROR_ENABLE_DEFVAL		XAIE2PGBL_PL_MODULE_MODULE_CLOCK_CONTROL_0_CTRL_PKT_TLAST_ERROR_ENABLE_DEFVAL
